...
import 'package:restfood/app/modules/restfood_detail/controllers/restfood_detail_controller.dart';
import 'package:restfood/app/modules/restfood_detail/views/component/bottom_sheet_review.dart';
import 'package:restfood/app/utils/utils.dart';

import '../../../constants/constants.dart';
import '../../../services/network/endpoints.dart';

class RestFoodDetailPage extends StatefulWidget {
  const RestFoodDetailPage({super.key});

  @override
  State<RestFoodDetailPage> createState() => _RestFoodDetailPageState();
}

class _RestFoodDetailPageState extends State<RestFoodDetailPage> {
  var arguments = Get.arguments;
  final RestFoodDetailController restfoodController =
      RestFoodDetailController.to;
  final FavoriteController favoriteController = FavoriteController.to;

  @override
  void initState() {
    // TODO: implement initState
    restfoodController.fetchDetailRestaurant(arguments);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Obx(() => (restfoodController.isLoading.isTrue)
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: ExtendedImage.network(
                                  ...
                                  width: 100.0.wp,
                                  Endpoints.getImage +
                                      restfoodController.restaurant.pictureId,
                                  cache: true,
                                  fit: BoxFit.fill,
                              ...
                              Positioned(
                                ...
                                child: favoriteController
                                        .checkIsFavorite(arguments)
                                    ? FloatingActionButton(
                                        onPressed: () {
                                          favoriteController
                                              .deleteFromFavorite(arguments);
                                        },
                                        child: Center(
                                          child: Icon(
                                            Icons.favorite,
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                children: [
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(restfoodController.restaurant.name,
                                            style: AppStyles
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              '${restfoodController.restaurant.rating}',
                              ...
                              Text(
                                restfoodController.restaurant.description,
                              ...
                              Wrap(
                                ...
                                direction: Axis.horizontal,
                                children:
                                    restfoodController.restaurant.menus.foods
                                        .map(
                                          (food) => Chip(
                                            label: Text(
                                              food.name,
                              ...
                              Wrap(
                                ...
                                direction: Axis.horizontal,
                                children:
                                    restfoodController.restaurant.menus.drinks
                                        .map(
                                          (food) => Chip(
                                            label: Text(
                                              food.name,
